<?php
function renderEventConfirmedEmail($name, $eventTitle, $eventDate, $location)
{
    return <<<HTML
<!DOCTYPE html>
<html>
...
<h2 style="color: #333;">You're in, {$name}!</h2>
<p style="font-size: 16px;">Your registration for <strong>{$eventTitle}</strong> is confirmed.</p>
